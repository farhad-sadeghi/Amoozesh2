...
<html lang="en">
  <head>
    <title>فروشگاه اینترنتی رایان رهجو</title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="d-flex align-items-center justify-content-between">
            <div class="logo">
              ...
              <div>&nbsp
                @if(!Auth::user())
                <a href="{{route('login')}}"  style="color:red; !important"> ورود</a>
                @else
                <a href="{{route('profile')}}"  style="color:red; !important"> مشخصات من</a>
                @endif
              </div>
              <div>&nbsp
                @if(!Auth::user())
                <a href="{{route('register')}}" style="color:red; !important"> ثبت نام</a>
                @else
                <a href="{{route('logout')}}"  style="color:red; !important">خروج</a>
                @endif
              </div>  </div>
            </div>
